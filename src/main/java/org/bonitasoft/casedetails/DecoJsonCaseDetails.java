...
public class DecoJsonCaseDetails {
    ...
    public Map<String, Object> getMap() {
         ...
         * {
         * // processInstanceMap.put("contract", getContractValuesBySql(processInstanceDescription.processDefinitionId, processInstanceDescription.id, null,
         * processAPI));
         ...
         * if (caseHistoryParameter.showContract && flownNodeInstance instanceof ArchivedHumanTaskInstance &&
         * ("ready".equalsIgnoreCase(flownNodeInstance.getState().toString())))
         * try {
